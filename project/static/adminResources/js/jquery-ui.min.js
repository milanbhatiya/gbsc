    ...
    t(document).mouseup(function () {
        ...
        t.position = {
            ...
            return b = s(y), y[0].preventDefault && (n.at = "left top"), m = b.width, g = b.height, v = b.offset, _ = t.extend({}, v), t.each(["my", "at"], function () {
                ...
                var s, l, u = t(this), c = u.outerWidth(), d = u.outerHeight(), f = i(this, "marginLeft"),
                    ...
                    S = d + b + i(this, "marginBottom") + w.height, C = t.extend({}, _),
                ...
                "right" === n.my[0] ? C.left -= c : "center" === n.my[0] && (C.left -= c / 2), "bottom" === n.my[1] ? C.top -= d : "center" === n.my[1] && (C.top -= d / 2), C.left += M[0], C.top += M[1], a || (C.left = h(C.left), C.top = h(C.top)), s = {
                    ...
                    var e = v.left - C.left, i = e + m - c, s = v.top - C.top, a = s + g - d, h = {
        ...
        return function (e, i, s, n) {
            ...
            var a = (e.positionAbs || e.position.absolute).left + e.margins.left,
                o = (e.positionAbs || e.position.absolute).top + e.margins.top, r = a + e.helperProportions.width,
                h = o + e.helperProportions.height, l = i.offset.left, u = i.offset.top, c = l + i.proportions().width,
        ...
        _mouseDrag: function (e) {
            var i, s, n = this.originalMousePosition, a = this.axis, o = e.pageX - n.left || 0,
                r = e.pageY - n.top || 0, h = this._change[a];
        ...
        start: function () {
            var e, i, s, n, a, o, r, h = t(this).resizable("instance"), l = h.options, u = h.element, c = l.containment,
            ...
            var i, s, n, a, o = t(this).resizable("instance"), r = o.options, h = o.containerOffset, l = o.position,
                u = o._aspectRatio || e.shiftKey, c = {top: 0, left: 0}, d = o.containerElement, p = !0;
        ...
        resize: function () {
            var e, i = t(this).resizable("instance"), s = i.options, n = i.size, a = i.originalSize,
        ...
        _intersectsWith: function (t) {
            var e = this.positionAbs.left, i = e + this.helperProportions.width, s = this.positionAbs.top,
                ...
                d = "y" === this.options.axis || e + u > a && o > e + u, p = c && d;
    ...
    t.effects = {effect: {}}, function (t, e) {
        ...
        p.style.cssText = "background-color:rgba(1,1,1,.5)", d.rgba = p.style.backgroundColor.indexOf("rgba") > -1, f(u, function (t, e) {
            ...
            parse: function (n, o, r, h) {
                ...
                var s = l(t), n = s._space(), a = u[n], o = 0 === this.alpha() ? l("transparent") : this,
        ...
        t.extend(t.effects, {
            version: "1.11.4", save: function (t, e) {
                ...
                var i, s;
                for (s = 0; e.length > s; s++) null !== e[s] && (i = t.data(o + e[s]), void 0 === i && (i = ""), t.css(e[s], i))
